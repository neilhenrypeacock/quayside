...
def create_app() -> Flask:
    ...
    def ops_dashboard():
        ...
        # Split into live vs pipeline (exclude demo ports from ops display)
        ...
        # Active scraper ports (excludes demo ports — seeded data would mask real scrape gaps)
    ...
    def trade_ports():
        ...
        # Supplement dict: slug → extra contact info not in DB
        _PORT_INFO = {
            "peterhead": {
    ...
    @app.route("/trade/feedback", methods=["POST"])
    def trade_feedback():
        """Store a trade dashboard feature request / feedback submission."""
        from quayside.db import insert_trade_feedback
